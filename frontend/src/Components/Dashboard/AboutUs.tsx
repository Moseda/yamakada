                    ...
                    <Col md={6}>
                      <Card className="mb-4">
                        <Card.Body>
                          ...
                          <p>
                            Mimuco was founded with a simple mission: to
                            simplify and streamline your daily organizational
                            needs. We believe in creating intuitive, powerful
                            tools that help individuals and teams work more
                            efficiently.
                          </p>
                        </Card.Body>
                      </Card>
